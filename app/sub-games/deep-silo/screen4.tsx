// app/sub-games/deep-silo/screen4.tsx
// Deep Silo - Level 4
...
const bg = require('@assets/images/backgrounds/subgames/silo-screen4.png')

export default function DeepSiloScreen4() {
  const router = useRouter()

  const handleDown = () => {
    if (__DEV__) console.log('[DeepSilo] Going deeper - screen 5')
    router.push('/sub-games/deep-silo/screen5' as any)
  }

  const handleBack = () => {
    if (__DEV__) console.log('[DeepSilo] Heading back up to screen 3')
    router.back()
  }
