// app/sub-games/deep-silo/screen5.tsx
// Deep Silo - Level 5
...
const bg = require('@assets/images/backgrounds/subgames/deep-silo/silo-screen5.webp')

export default function DeepSiloScreen5() {
  const router = useRouter()

  const handleDown = () => {
    if (__DEV__) console.log('[DeepSilo] Going deeper - screen 6')
    router.push('/sub-games/deep-silo/screen6' as any)
  }

  const handleBack = () => {
    if (__DEV__) console.log('[DeepSilo] Heading back up to screen 4')
    router.back()
  }
