// app/sub-games/deep-silo/screen3.tsx
// Deep Silo - Level 3
...
const bg = require('@assets/images/backgrounds/subgames/deep-silo/silo-screen3.webp')

export default function DeepSiloScreen3() {
  const router = useRouter()

  const handleDown = () => {
    if (__DEV__) console.log('[DeepSilo] Going deeper - screen 4')
    router.push('/sub-games/deep-silo/screen4' as any)
  }

  const handleBack = () => {
    if (__DEV__) console.log('[DeepSilo] Heading back up to screen 2')
    router.back()
  }
