...
describe('Current-Loom Tier 2 catalog', () => {
  it('contains two real, independently authored instances keyed by instanceId', () => {
    expect(Object.keys(RAW_CURRENT_LOOM_CONTENT)).toEqual(['current-loom-01', 'current-loom-02'])
  ...
  it('shares the identical five visual asset ids across both instances', () => {
