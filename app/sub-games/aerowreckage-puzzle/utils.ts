 ...
 */
export function angleToNumber(angle: number, totalNumbers: number = PUZZLE_CONFIG.totalNumbers): number {
 ...
 */
export function numberToAngle(number: number, totalNumbers: number = PUZZLE_CONFIG.totalNumbers): number {
