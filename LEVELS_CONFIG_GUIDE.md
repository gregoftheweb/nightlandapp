...
export const levels: Record<LevelId, Level> = {
  ...
  "3": {
    ...
    // Entities
    items: [
      createItemInstance("healthPotion", { row: 450, col: 250 }),
    ],
    
    monsters: loadSpawnTable("wasteland_common", createMonsterInstance),
    
    objects: [
      createObjectInstance("cursedTotem", { row: 300, col: 250 }),
    ],
...
export const SPAWN_TABLES: Record<SpawnTableId, SpawnConfig[]> = {
  ...
  forest_boss: [
    { monsterShortName: "forest_guardian", spawnRate: 0.01, maxInstances: 1 },
  ],
};
```
