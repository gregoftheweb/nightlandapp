...
exports.getAllWeaponIds = exports.getRangedWeapons = exports.getMeleeWeapons = exports.getWeaponByShortName = exports.getWeaponById = exports.weaponsCatalog = void 0;
/**
...
exports.weaponsCatalog = [
    ...
    },
    {
        ...
        name: 'Lazer Pistol',
        description: 'A high-tech energy weapon salvaged from the aerowreckage. Fires concentrated beams of orange light.',
        damage: 7,
        hitBonus: 2,
        effects: [],
        type: 'weapon',
 ...
 */
var getWeaponById = function (weaponId) {
    return exports.weaponsCatalog.find(function (weapon) { return weapon.id === weaponId; });
};
 ...
 * @returns The weapon item or undefined if not found
 */
var getWeaponByShortName = function (shortName) {
    return exports.weaponsCatalog.find(function (weapon) { return weapon.shortName === shortName; });
};
exports.getWeaponByShortName = getWeaponByShortName;
/**
 * Get all melee weapons
 * @returns Array of melee weapon items
 */
var getMeleeWeapons = function () {
    return exports.weaponsCatalog.filter(function (weapon) { return weapon.weaponType === 'melee'; });
};
exports.getMeleeWeapons = getMeleeWeapons;
/**
 * Get all ranged weapons
 * @returns Array of ranged weapon items
 */
var getRangedWeapons = function () {
    return exports.weaponsCatalog.filter(function (weapon) { return weapon.weaponType === 'ranged'; });
};
exports.getRangedWeapons = getRangedWeapons;
/**
 * Get all available weapon IDs
 * @returns Array of weapon IDs
 */
var getAllWeaponIds = function () {
    return exports.weaponsCatalog.map(function (weapon) { return weapon.id; });
};
exports.getAllWeaponIds = getAllWeaponIds;
