...
export interface PoolTemplate {
  ...
  maxInstances: number;
  effects: Effect[];
  decayTime?: number; // How long the pool lasts (milliseconds)
}
...
export interface PoolInstance {
  ...
  name?: string;
  description?: string;
  usesRemaining?: number; // How many times it can be used
...
export interface GreatPower extends Monster {
  ...
  awakenCondition: "player_within_range" | "hp_threshold" | "time_elapsed" | "item_collected";
...
export interface BossObjective {
  type: "defeat_boss" | "survive_waves" | "reach_position" | "collect_item" | "protect_npc";
...
export interface BossFailureCondition {
  type: "player_death" | "time_expired" | "objective_failed" | "target_destroyed";
  description: string;
}
