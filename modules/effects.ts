...
const executeHealEffect = (effect: Effect, context: EffectExecutionContext): EffectResult => {
  ...
  // Show feedback
  const message = effect.successMessage || `Restored ${actualHealAmount} HP! (${newHp}/${maxHp})`
...
export const executeEffect = (effect: Effect, context: EffectExecutionContext): EffectResult => {
...
export const useItem = (item: Item, context: EffectExecutionContext): EffectResult => {
